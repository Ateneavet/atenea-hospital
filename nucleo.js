...
const CONSTRUIDAS = new Set(["bienvenida", "hospital", "ficha", "boxes", "historial", "configuracion", "agenda", "clientes", "peluqueria", "precios", "detalle", "consultas", "nuevaConsulta", "detalleConsulta", "recordatorios", "caja"]);
...
function pintar() {
  ...
  const pantallas = {
    ...
    recordatorios: verRecordatorios, caja: verCaja,
  };
